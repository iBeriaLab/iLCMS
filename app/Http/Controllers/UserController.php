...
class UserController extends Controller {
    ...
    public function getUserProfile($id){
        ...
        return view('admin.users.profile')->with(array("profile" => $profile, "posts" => $posts));
    }
    ...
    public function account()
    {
        ...
        //$posts = Posts::where('author_id','=',$id)->get()->first();, array('posts' => $posts)

        $posts = $user->posts()->get();

        return view('admin.account')->with(array("user" => $user, "posts" => $posts));
    }


    public function up_avatar(Request $request)
    {
        ...
        return view('admin.account', array('user' => Auth::user()));
    }
