...
$(function() {
    ...
    $('.breadcrumb-line').has('.breadcrumb-elements').prepend('<a class="breadcrumb-elements-toggle font1"><i class="icon-menu-open"></i></a>');
    ...
    $('.menu-list').find('li').has('ul').parents('.menu-list').addClass('has-children font1');

    // Attach drill down menu to menu list with child levels
    $('.has-children').dcDrilldown({
        defaultText: 'უკან დაბრუნება',
        saveState: true
    });
...
// მთავარი რუკა
    ...
    new Chart(document.getElementById("line-chart"), {
        ...
        data: {
            ...
            datasets: [{
                data: [ian,teb,mar,apr,mai,ivn,ivl,agv,sec,oct,noe,dec],
                label: "მომხმარებელი",
                borderColor: "#90A4AE",
                fill: false
            }
