$(function() {
    ...
    function e(t, e) {
        ...
        $(".multiselect-container input").uniform({
            radioClass: "choice"
        }), d3.csv("http://blog.dev/assets/demo_data/dashboard/app_sales.csv", function(t, e) {
            formatted = e, n()
        });
        var h;
    ...
    function a() {
        d3.csv("http://blog.dev/assets/demo_data/dashboard/app_sales_heatmap.csv", function(t, e) {
            function a() {
    ...
    function i(t, e, a, n, r, i, s, l) {
        ...
        for (var c = d3.select(t), u = {
            ...
            bottom: 0,
            left: 0
        }, p = c.node().getBoundingClientRect().width - u.left - u.right, n = n - u.top - u.bottom, f = [], h = 0; h < a; h++) f.push(Math.floor(Math.random() * a) + 5);
    ...
    function u(t, e, a, n, r, i, s, l, o) {
        ...
        for (var p = [], f = 0; f < e; f++) p.push(Math.round(10 * Math.random()) + 10);
        var h = d3.select(t),
