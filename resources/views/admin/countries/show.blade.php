                ...
                <div class="panel">
                    ...
                    <div class="panel panel-flat">
                        <div class="panel-heading">
                            <h5 class="panel-title font1"><img style="width: 26px;" src="{{ url('/') }}/images/flags/svg/{{ strtolower($country['countrycode']) }}.svg" alt="{{ $country['countryname'] }}"> {{ $country->countryname }}</h5>
                            <div class="heading-elements">
                                <ul class="icons-list">
