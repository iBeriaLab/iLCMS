...
@section('js')
    ...
    <script>
        ...
        var like_all;
        like_all = '{{ \App\Like::all()->count() }}';



       let like_count = "{{ \App\Like::where('like','=','1')->whereMonth('created_at','=','08')->count() }}";
       let like_created_at = "{{ \App\Like::whereMonth('created_at','=','08')->count() }}";
       let dislike_count = "{{ \App\Like::where('like','=','0')->count() }}";

        let like_p = like_count / 100 / like_all;
        let dislike_p = dislike_count / 100 / like_all;
    ...
    <script type="text/javascript">
        ...
        $.getJSON('http://blog.dev/api/v0.1/countries', function (data) {
            // demoP = document.getElementById("log");

            //demoP.innerHTML = demoP.innerHTML + "<li>" + i + " - " + data.countries[i].countryname + "</li>"
    ...
    <div class="page-header">
        <div class="page-header-content">
            <div class="page-title">
                <h4>
                   <span class="text-semibold text-purple-400 font1">მთავარი</span> <small class="text-grey"> @yield('title')</small>
    ...
    <div class="page-container">
        ...
        <div class="page-content">
            ...
            <div class="content-wrapper">
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="panel bg-indigo-300">
                            <div class="panel-body">
                                ...
                                <h3 class="no-margin font1">{{ count(App\User::all()) }}</h3>
                                <small class="font1"> მომხმარებელი</small>
                                <div class="text-muted text-size-small font1">489 avg</div>
                            </div>
                                    ...
                                    <ul class="icons-list">
                                        <li class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-right">
                                                <li><a href="{{ route('posts.index') }}"><i class="icon-pencil6"></i> სტატიები</a></li>
                                                <li><a href="#"><i class="icon-list-unordered"></i> კატეგორიები</a></li>
                                            </ul>
                                        </li>
                                    </ul>
                                </div>

                                <h3 class="no-margin font1">{{ count(App\Posts::all()) }}</h3>
                                <small class="font1"> სტატია</small>
                                <div class="text-muted text-size-small font1">34.6% avg</div>
                            </div>
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="panel bg-slate">
                            <div class="panel-body">
                                ...
                                <h3 class="no-margin font1">$18,390</h3>
                                <small class="font1">Today's revenue</small>
                                <div class="text-muted text-size-small font1">$37,578 avg</div>
                            </div>
                ...
                <div class="map-container map-world mb-20"></div>
                ...
                <script type="application/javascript">
                    ...
                    $('.map-world').vectorMap({
                        ...
                        onMarkerClick: function(events, index, weburl) {
                            ...
                            url = 'app/capital/' + markers[index].weburl;
...
<div class="row">
                ...
                <div class="panel">
                    <div class="panel-body">
                        <canvas id="likes-chart" width="400" height="140"></canvas>
                    </div>
                </div>
                    ...
                    <div class="panel panel-body">
                        <div class="row text-center">
                            <div class="col-xs-4">
                                ...
                                <h5 class="text-semibold no-margin">{{ \App\User::all()->count() }}</h5>
                                <span class="text-muted text-size-small">მომხმარებელი</span>
                            </div>

                            <div class="col-xs-4">
                                <p><i class="icon-thumbs-up3 icon-2x display-inline-block text-success"></i></p>
                                <h5 class="text-semibold no-margin">{{ \App\Like::where('like','=','1')->count() }}</h5>
                                <span class="text-muted text-size-small">მოწონება</span>
                            </div>

                            <div class="col-xs-4">
                                <p><i class="icon-pencil6 icon-2x display-inline-block text-danger"></i></p>
                                <h5 class="text-semibold no-margin">{{ \App\Posts::where('author_id','=',Auth::user()->id)->count() }}</h5>
                                <span class="text-muted text-size-small">პოსტი</span>
                            </div>
                        </div>
                    </div>
                ...
                <script>
                    ...
                    var like = '{{ \App\Like::where('like','=','1')->count() }}';
                    var dislike = '{{ \App\Like::where('like','=','0')->count() }}';
                   ...
                   var ian = '{{ \App\User::whereMonth('created_at', '01')->count() }}';
                   var teb = '{{ \App\User::whereMonth('created_at', '02')->count() }}';
                   var mar = '{{ \App\User::whereMonth('created_at', '03')->count() }}';
                   var apr = '{{ \App\User::whereMonth('created_at', '04')->count() }}';
                   var mai = '{{ \App\User::whereMonth('created_at', '05')->count() }}';
                   var ivn = '{{ \App\User::whereMonth('created_at', '06')->count() }}';
                   var ivl = '{{ \App\User::whereMonth('created_at', '07')->count() }}';
                   var agv = '{{ \App\User::whereMonth('created_at', '08')->count() }}';
                   var sec = '{{ \App\User::whereMonth('created_at', '09')->count() }}';
                   var oct = '{{ \App\User::whereMonth('created_at', '10')->count() }}';
                   var noe = '{{ \App\User::whereMonth('created_at', '11')->count() }}';
                   var dec = '{{ \App\User::whereMonth('created_at', '12')->count() }}';
...
<div class="col-lg-6">
    ...
    <div class="col-lg-6">
                ...
                <!-- /support tickets -->
                            ...
                            <div class="content-group">
                                <div class="row row-seamless btn-block-group">
                                        ...
                                        <div id="log">
                                            <div v-for="(index, country) in countries" v-if="index < 19" style="width:5%;float: left;height:53px;">

                                                    <a href="{{ url('/app/country') }}/@{{ country.id }}" class="btn btn-default btn-block btn-float btn-float-lg legitRipple">
                                                        <img src="{{ url('/images/flags/svg') }}/@{{ country.countrycode }}.svg" style="width: 23px;">

                                                    </a>

                                            </div>
                                            <div style="width:5%;float: left;height:50px;font-size: 10px">
                                                <button type="button" class="btn btn-default btn-block btn-float btn-float-xs legitRipple">
                                                    <i class="icon-arrow-right15 text-warning-600"></i>
                                                </button>
                                            </div>
                                        </div>
            ...
            </div><small class="text-muted">გვერდი ნანახია: {{ Counter::showAndCount('home') }}-ჯერ </small>
