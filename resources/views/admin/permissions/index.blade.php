            ...
            <div class="content-wrapper">
                ...
                <div class="panel panel-flat">
                    <div class="panel-heading">
                        <h6 class="panel-title">უფლებები<a class="heading-elements-toggle"><i class="icon-more"></i></a></h6>
                            ...
                            <ul class="nav nav-pills">
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right">
                                        <li><a href="{{ URL::to('app/permissions/create') }}"><i class="icon-add-to-list"></i> უფლებების დამატება</a></li>
                   ...
                   <!-- <div class="panel-body">
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table text-nowrap">
                            ...
                            <tr>
                                <th>დასახელება</th>
                                <th class="col-md-2">მოქმედება</th>
                            </tr>
                            </thead>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ URL::to('app/permissions/'.$permission->id.'/edit') }}" type="button" class="btn bg-purple btn-icon legitRipple"><i class="icon-pencil-ruler"></i> შესწორება</a>
