            ...
            <div class="content-wrapper">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        {{ Form::model($post, array('route' => array('posts.update', $post->id), 'method' => 'PUT', 'enctype'=>'multipart/form-data', 'files' => true)) }}
                        <div class="form-group">
                            ...
                            <br><br><br><br>
                            <div class="col-md-12">
                            {{ Form::textarea('body', null, array('class' => 'form-control ckeditor')) }}<br>
                            </div>
