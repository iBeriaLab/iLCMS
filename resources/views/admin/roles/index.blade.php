        ...
        <div class="page-header-content">
            <div class="page-title">
                <h4>
                    ...
                    <span class="text-semibold">მთავარი</span> - მართვის პანელი
            ...
            <div class="content-wrapper">
                ...
                <div class="panel panel-flat">
                    <div class="panel-heading">
                        <h6 class="panel-title">როლები<a class="heading-elements-toggle"><i class="icon-more"></i></a></h6>
                        <div class="heading-elements panel-nav">
                            <ul class="nav nav-pills">
                                <li><a href="{{ route('users.index') }}" class="legitRipple"><i class="icon-users position-left"></i> მომხმარებლები</a></li>
                                <li><a href="{{ route('permissions.index') }}" class="legitRipple"><i class="icon-cog3 position-left"></i> უფლებები</a></li>
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right">
                                        <li><a href="{{ URL::to('app/roles/create') }}"><i class="icon-add-to-list"></i> როლის დამატება</a></li>
                    ...
                    <table class="table text-nowrap">
                        <thead>
                        <tr>
                            <th class="col-md-2">როლი</th>
                            <th class="col-md-5">უფლებები</th>
                            <th>მოქმედება</th>
                        </tr>
                        </thead>
                        ...
                        @foreach ($roles as $role)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ URL::to('app/roles/'.$role->id.'/edit') }}" class="btn bg-purple-400 pull-left" style="margin-right: 3px;"><i class="icon-pencil-ruler"></i> შესწორება</a>
