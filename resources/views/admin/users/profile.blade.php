...
@section('title', 'მომხმარებლის პროფილი')
@show
@section('content')
                                                    ...
                                                    <div class="timeline-row">
                                                        ...
                                                        <div class="panel panel-flat timeline-content">
                                                            ...
                                                            <div class="panel-heading">
                                                                <h6 class="panel-title">{{ $post->title }} -- {{ $post->author_id }}</h6>
                                                                <div class="heading-elements">
                                                                    <span class="heading-text"><i class="icon-checkmark-circle position-left text-success"></i> {{ $post->created_at }}</span>
                                                                    <ul class="icons-list">
                                                                        <li class="dropdown">
                                                            ...
                                                            <div class="panel-footer panel-footer-transparent">
                                                                <div class="heading-elements">
                                                                    <ul class="list-inline list-inline-condensed heading-text">
                                                                        @can('post edit')
                                                                            <li><a href="{{ url('/') }}/app/post/edit/{{ $post->id }}" class="text-default"><i class="icon-database-edit2 position-left"></i></a></li>
                                                                        @endcan
                                                                    </ul>

                                                                    <span class="heading-btn pull-right">
																<a href="{{ url('/') }}/app/post/{{ $post->id }}" class="btn btn-link">სრულად <i class="icon-arrow-right14 position-right"></i></a>
															</span>
                                                                </div>
                                                            </div>
                                                        </div>
                    ...
                    <div class="col-lg-3">
                        ...
                        <div class="thumbnail">
                            <div class="thumb thumb-rounded thumb-slide">
                                <img src="/images/avatars/{{  $profile->avatar }}" alt="">
                                <div class="caption">
									<span>
                            ...
                            <div class="caption text-center">
                                <h6 class="text-semibold no-margin">{{  $profile->name }} {{  $profile->lastname }} <small class="display-block">{{ $profile->roles()->pluck('name')->implode(' ') }}</small></h6>
